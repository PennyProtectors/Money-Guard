  ...
  return (
    <table className={css.transactionsList_Table}>
      ...
      >
        ...
        <th colSpan="2" className={css.column}>
          Sum
        </th>
      </tr>
      <tr className={css.transactionsList_Table_Row}>
        <td className={css.date}>04.01.23</td>
        <td className={css.type}>-</td>
        <td className={css.category}>Other</td>
        <td className={css.comment}>Gift for your wife</td>
        <td className={css.actions}>
          <span className={css.sum}>300.00</span>
          <div className={css.buttons}>
            <button
              type="button"
              onClick={() => {}}
              className={`${css.button} ${css.btnSmall} ${css.bgTrans}`}
            >
              <svg
                width="14"
                height="13"
